/*
Задача:
Дано асинхронную написать свою реализацию Promise.AllSettled, функция принимает массив значений, которые могут быть как промисами, так и обычными значениями, и возвращает массив с результатами выполнения всех этих значений. 
